...
{
    [TestFixture]
    public class Test_APITestRepoEvgeni
    {
        ...
        public void Setup()
        {
            this.baseUrl = "https://api.github.com/repos/evgenidimitrov01/test_repo";
        ...
        {
            //Arrange
            IRestClient client = new RestClient(baseUrl + "/issues/3");
            client.Timeout = 3000;
            client.Authenticator = new HttpBasicAuthenticator(authUserName, authUserToken);
            IRestRequest request = new RestRequest(Method.GET);
        ...
        {
            //Arrange
            IRestClient client = new RestClient(baseUrl + "/issues/3/labels");
            client.Timeout = 3000;
            client.Authenticator = new HttpBasicAuthenticator(authUserName, authUserToken);
            IRestRequest request = new RestRequest(Method.GET);
        ...
        {
            //Arrange
            IRestClient client = new RestClient(baseUrl + "/issues/2/comments");
            client.Timeout = 3000;
            client.Authenticator = new HttpBasicAuthenticator(authUserName, authUserToken);
            IRestRequest request = new RestRequest(Method.GET);
        ...
        {
            //Arrange
            IRestClient client = new RestClient(baseUrl + "/issues/comments/790803972");
            client.Timeout = 3000;
            client.Authenticator = new HttpBasicAuthenticator(authUserName, authUserToken);
            IRestRequest request = new RestRequest(Method.GET);
